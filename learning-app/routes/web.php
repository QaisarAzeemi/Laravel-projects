...
// Route::post('search', [UserController::class, 'fetchSingleBlog']);
...
//Route::get('search', [UserController::class, 'fetchSingleBlog']);
...
//     if (request('search')) {
//         $blogs = blogentrie::where('Id', 'like', '%' . request('search') . '%')->get();
//     } else {
//         $blogs = blogentrie::all();
//     }
